...
class DataLoader {
    constructor(prisma, maxFootpathDistanceMeter = 500) {
        this.prisma = prisma;
    ...
    async loadData() {
        ...
        const routeSignatureToPatternId = new Map();
        ...
        try {
            ...
            if (fs.existsSync(filePath)) {
                ...
                for (const stopId of Object.keys(precomputed)) {
                    const filtered = precomputed[stopId].filter((t) => t.distanceMeter <= this.maxFootpathDistanceMeter);
